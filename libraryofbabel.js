export const length_of_page = 3200;
export const length_of_title = 25;
...
export const search = search_str => {
  ...
  let hex = '';
  let depth = parseInt(Math.random() * (exports.length_of_page - search_str.length));
...
export const searchTitle = search_str => {
  //randomly generate location numbers
  let wall = ''+parseInt(Math.random()*3+1)
  let shelf = ''+parseInt(Math.random()*4+1)
  let volume = pad(''+parseInt(Math.random()*31+1), 2)
